...
def plan_solve(problem_id: str):
    ...
    metam.metacognition(problem_id, system1_solver, system2_solver, context_file, thresholds_file, experience_file, new_run)
...
if __name__ == "__main__":
    ...
    problems = generate_bodmas_problems(
        n_problems=10,         # Number of problems per depth level
        depth_list=[1]  # Different complexity levels (depth of the expression)
    )
